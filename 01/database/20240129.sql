...
CREATE TABLE `book` (
  ...
  `room` text NOT NULL,
  `firstday` double NOT NULL,
  `lastday` double NOT NULL,
...
INSERT INTO `book` (`id`, `room_id`, `name`, `email`, `phone`, `remark`, `room`, `firstday`, `lastday`, `create_day`) VALUES
(1, 2147483647, 'test1', 'test1@gmail.com', '0123456798', '', '7', 1709654400000, 1709654400000, '2024-01-29');
